...
function highlight(tasks, calendarMonthNum) {
    const chalk = require('chalk'),
          ...
          monthBeginMoment  = moment().month(calendarMonthNum-1),
          monthEndMoment    = monthBeginMoment.endOf('month'),
          daysInMonth       = monthEndMoment.date(),
          dayOfWeekMonthStartsOn = monthBeginMoment.isoWeekday(),
          dayOfWeekMonthEndsOn   = monthEndMoment.isoWeekday(),
          monthHeader            = require('center-align')(monthBeginMoment.format('MMMM YYYY'),20);
